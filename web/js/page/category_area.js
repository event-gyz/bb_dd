define(function(require, exports) {
    ...
    require('//links.eventown.com.cn/vendor/nprogress/nprogress.js');
    ...
    $(document).ready(function() {
        ...
        var getJumpUrl = (function() {
            var url = ''
            if( GLOBAL.inviteId > 0 ){
                return url = '/sendrfp/selectmini?';
            }
            
            if (typeof GLOBAL.page_name != 'undefined' && GLOBAL.page_name == 'min_search') {
                return url = '/sendrfp/select?'
            } else {
                return url = '/sendrfp/select?'
            }
        })()
        ...
        function go(data) {
            NProgress.start();
            param = $.extend(param, data,{'id':GLOBAL.id,'type':GLOBAL.type,'inviteId':GLOBAL.inviteId});
