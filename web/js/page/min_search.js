...
define(function (require, exports) {
    ...
    var cookieName = "place_list_store_for_business";
    //加入询单列表
    ...
    (function(){
        ...
        $('.box').height(wH-fH-30).css('overflow','hidden');
        $('#mapElment').height(wH-nH-fH-130);
        $('.select-business').height(wH-nH-fH-130).css('overflow','auto')
        $(window).resize(function(){
            var sH=$(window).height();
            $('.box').height(sH-fH).css('overflow','hidden');
            $('#mapElment').height(sH-nH-fH-120);
            $('.select-business').height(sH-nH-fH-130).css('overflow','auto')
        })
    })()
    
    var cW=$('#content').width();
    var lW=$('.select-business').width();
    $('.rightMap').width(cW-lW-10);
    $('#mapElment').width(cW-lW-10);
    ...
    (function(){
        ...
        $('.select-business').height(wH-nH-fH-80).css('overflow','auto')
        
        $(window).resize(function(){
            var sH=$(window).height();
            $('.box').height(sH-nH-fH).css('overflow','hidden');
            $('#mapElment').height(sH-nH-fH);
            $('.select-business').height(sH-nH-fH-80).css('overflow','auto')
        })
    })()
